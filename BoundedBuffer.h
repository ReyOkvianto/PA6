...
private:
	...
	condition_variable slot_available; //waited on by the push, signaled by pop functions
...
public:
	...
	int pop(char* buf, int bufcap){
		...
		//2. pop the front item of the queue. The popped item is a vector<char>, watch for racecondition
